...
export default function TermsOfServicePage() {
  const metaBadges: MetaBadge[] = [
    ...
    { icon: HelpCircle, label: "Support: support@VEYRA.com" },
  ];
  ...
  const sections: InfoSection[] = [
    {
      ...
      content: (
        <>
          <p>
            By accessing or using the VEYRA platform, web application, API, or service, you agree to comply with and be bound by these Terms of Service. If you do not agree to these terms, please do not use or access our services.
          </p>
          <p>
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            To access certain features of VEYRA, you must create a personal account. When registering, you agree to:
          </p>
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            You are solely responsible for all content, schedules, and prompts created on your VEYRA account. You agree not to use VEYRA to:
          </p>
          <ul className="list-disc pl-5 space-y-1 mt-2">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            At the end of each billing cycle, your subscription will automatically renew under the exact same conditions unless you cancel it or VEYRA cancels it. You can cancel your subscription renewal at any time via your account settings page.
          </p>
        </>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <>
          <p>
            VEYRA is provided on an "AS IS" and "AS AVAILABLE" basis. We make no warranties, expressed or implied, regarding the uptime, accuracy of AI generated outputs, or fitness of the platform for a particular commercial purpose.
          </p>
          <p>
            In no event shall VEYRA, its founders, or employees be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the platform.
          </p>
        </>
      ),
    },
  ...
  return (
    <InfoLayout
      ...
      description="Read the rules, terms, and guidelines that govern your usage of VEYRA. By using our platform, you agree to these legal conditions."
